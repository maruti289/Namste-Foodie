...
const ResCard = (props)=>
{
    ...
    const { name, cloudinaryImageId, avgRating, areaName, deliveryTime, id } = resData || {};


    return(
        <div className='res-card'>
            <img  className="img-class" src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/"+resData.info.cloudinaryImageId}/>
    ...
    return(
        <div className='BodyComponent'>
            ...
            <div className='Res-Container'>
                {restaurantList.map((restaurant) =>( <ResCard resData={restaurant}/>))}
            </div> 
        </div>
    )
}
